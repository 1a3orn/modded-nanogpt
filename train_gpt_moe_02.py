...
class MLPMoEComm(nn.Module):
    def __init__(self, dim, num_experts=2, expansion_factor=4):
        ...
        self.shared_mlp = MLP(dim, self.expansion_factor // 2)
...
class ValueEmbedding(nn.Module):
    ...
    def forward(self, input_seq) -> list[Tensor | None]:
        ...
        ve = [ve[0], ve[1], None, None, None, None, ve[0], ve[1]]
        return ve
...
model = GPT(vocab_size=50257, num_layers=8, num_heads=6, model_dim=768).cuda()
