...
if master_process:
    ...
    print(logfile)
    wandb.init(project="nanogpt-base", config=args, experiment="07_heads")
...
model: nn.Module = GPT(vocab_size=args.vocab_size, num_layers=12, num_heads=12, model_dim=768,
