...
optimizer1 = DistAdam(scalar_params + head_params + embed_params, lr=0.008 * 1.2, betas=(0.8, 0.95), eps=1e-10, weight_decay=0.0)
optimizer2 = Muon(hidden_matrix_params, lr=0.05 * 1.2, momentum=0.95, weight_decay=0.0)
