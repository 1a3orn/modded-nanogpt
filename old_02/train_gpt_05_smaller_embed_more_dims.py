...
if master_process:
    ...
    print(logfile)
    wandb.init(project="nanogpt_experiment", config=args, name="05_smaller_embed_more_dims")
...
model: nn.Module = GPT(vocab_size=args.vocab_size, num_layers=12, num_heads=7, model_dim=768 + 128,
